...
async function onRequestPost2({ request, env }) {
  const errorResponse = /* @__PURE__ */ __name((message, status = 500) => {
    return new Response(
  ...
  const successResponse = /* @__PURE__ */ __name((message = "Subscribed successfully") => {
    return new Response(
...
// ../.wrangler/tmp/pages-jaZPQ1/functionsRoutes-0.9932785214737765.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-XJhy3S/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-XJhy3S/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7405715275981499.mjs.map
