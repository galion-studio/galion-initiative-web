...
// .wrangler/tmp/pages-jaZPQ1/functionsWorker-0.7405715275981499.mjs
...
async function onRequestPost2({ request, env }) {
  const errorResponse = /* @__PURE__ */ __name2((message, status = 500) => {
    return new Response(
  ...
  const successResponse = /* @__PURE__ */ __name2((message = "Subscribed successfully") => {
    return new Response(
  ...
  try {
    ...
    const finalMessage = errorMessage.includes("database") || errorMessage.includes("DB") ? "Database error. Please try again later." : "Internal server error. Please try again.";
...
// .wrangler/tmp/bundle-Mfxtcm/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Mfxtcm/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7405715275981499.js.map
